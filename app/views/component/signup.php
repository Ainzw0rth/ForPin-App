    ...
    <div>
        ...
        <form class="signup-form">
            ...
            <div class="signup-form-section">
                ...
                <p id="email-warn" class="signup_warn-hide"></p>
                ...
                <p id="username-warn"class="signup_warn-hide"></p>
                ...
                <p id="fullname-warn" class="signup_warn-hide"></p>
                
                <label for="password" class=text-1-normal class="signup_warn-hide">Password</label>
                <input type="password" placeholder="Password" id="password" name="password" class="input-login">
                <p id="password-warn" class="signup_warn-hide"></p>
                ...
                <p id="confirm-password-warn" class="signup_warn-hide"></p>
            </div>
