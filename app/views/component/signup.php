<div class="flex justify-center align-center">
    <div>
        <div class="top-section">
            ...
            <div class="flex justify-center">
                <p class=text-1-normal>Sign up for free.</p>
            </div>
        </div>
        ...
        <form class="signup-form">
            ...
            <div class="signup-form-section">
                ...
                <p id="email-warn" class=text-1-normal class="warn-hide"></p>
                ...
                <p id="username-warn" class=text-1-normal class="warn-hide"></p>
                ...
                <p id="fullname-warn" class=text-1-normal class="warn-hide"></p>
                ...
                <p id="password-warn" class=text-1-normal class="warn-hide"></p>
                ...
                <p id="confirm-password-warn" class=text-1-normal class="warn-hide"></p>
            </div>
