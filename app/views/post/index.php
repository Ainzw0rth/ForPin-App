...
<body>
    ...
    <a>
        <button id="go-back-button" class="go-back">
        <!-- <button class="go-back" onClick="location.href='<?= BASE_URL; ?>/home'"> -->
            ...
            <div class = "card-text-1">
                ...
                <div class="card-additional">
                    ...
                    <div class="additional-section">
                        ...
                        <div class="button-circle">
                            <a class="edit-button" href="#edit-post">
                        ...
                        <div class="button-circle">
                            <a class="delete-button" href="#delete-post">
    ...
    <!-- modal section -->
    <div id="delete-post" class="modal-window">
        <div>
    ...
    <div id="edit-post" class="modal-window">
        <div>
